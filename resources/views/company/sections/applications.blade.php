                ...
                <div class="p-6 hover:bg-gray-50 transition-colors duration-200">
                    <div class="flex flex-col lg:flex-row lg:items-center gap-4">
                        <div class="flex items-center space-x-4 flex-1">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full flex items-center justify-center text-white font-semibold flex-shrink-0">
                                {{ strtoupper(substr($application->user->name ?? 'U', 0, 1)) }}{{ strtoupper(substr(explode(' ', $application->user->name ?? 'User')[1] ?? '', 0, 1)) }}
                            </div>
                            <div class="flex-1 min-w-0">
                                <h4 class="font-semibold text-gray-800">
                                    {{ $application->user->name ?? 'Unknown User' }}</h4>
                                ...
                                <div class="flex items-center gap-4 mt-1 flex-wrap">
                                    ...
                                    <span
                                        class="text-xs text-gray-500 truncate">{{ $application->user->email ?? 'No email' }}</span>
                        ...
                        @else bg-gray-100 text-gray-700 @endif">
                            ...
                            <div class="flex gap-2">
                                <button type="button"
                                    ...
                                    onclick="openApplicantModal({{ $application->id }})">
...
<script>
    ...
    function confirmRejectApplication(applicationId, applicantName, jobTitle) {
        try {
            ...
            if (confirm(
                    `Are you sure you want to reject ${applicantName}'s application for ${jobTitle}? This action cannot be undone.`
                    )) {
                const form = document.createElement('form');
                form.method = 'POST';
    ...
    <div class="modal-content bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div class="p-6">
            ...
            <div class="flex items-center mb-6">
                ...
                <button type="button" onclick="closeScheduleInterviewModal()"
            ...
            <div class="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-6">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-gray-900">Interview with <span id="interviewApplicantName"
                                class="text-purple-600"></span></h4>
                        <p class="text-sm text-gray-600">For the position: "<span id="interviewJobTitle"
            ...
            <form id="scheduleInterviewForm" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <select id="interviewTime" name="interview_time" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label
                            ...
                            <input type="radio" name="interview_type" value="in-person"
                                class="mr-3 text-purple-600" required>
                            <div class="flex items-center">
                        ...
                        <label
                            class="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                            <input type="radio" name="interview_type" value="online" class="mr-3 text-purple-600"
                                required>
                            <div class="flex items-center">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="interviewNotes" name="interview_notes" rows="3"
                    ...
                    <div class="flex items-start space-x-2">
                        ...
                        <div class="text-sm text-blue-800">
                            ...
                            <div class="mt-1 text-xs space-y-1">
                                <p>• Application status updated to "Interview" • Applicant receives email notification
                                </p>
...
<div id="rejectApplicationModal"
    class="fixed inset-0 bg-black bg-opacity-50 modal-hidden items-center justify-center z-50">
        ...
        <div class="p-6">
            ...
            <div class="mb-6">
                <p class="text-gray-700 mb-4">
                    Are you sure you want to reject <span id="applicantName" class="font-semibold"></span>'s
                    application for "<span id="jobTitle" class="font-semibold"></span>"?
                </p>
            ...
            <div class="flex space-x-3 justify-end">
                <button type="button" onclick="closeRejectApplicationModal()"
...
<div id="approveApplicationModal"
    class="fixed inset-0 bg-black bg-opacity-50 modal-hidden items-center justify-center z-50">
    <div class="modal-content bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        <div class="p-6">
            <!-- Modal Header -->
            ...
            <div class="mb-6">
                <p class="text-gray-700 mb-4">
                    Are you sure you want to approve <span id="approveApplicantName" class="font-semibold"></span> for
                    "<span id="approveJobTitle" class="font-semibold"></span>"?
                </p>
            ...
            <!-- Modal Actions -->
            <div class="flex space-x-3 justify-end">
                <button type="button" onclick="closeApproveApplicationModal()"
                    class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium">
                    <i class="ri-arrow-left-line mr-1"></i>
                    Cancel
                </button>
