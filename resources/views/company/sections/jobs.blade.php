...
<div class="mt-8 flex items-center justify-between">
    <div class="text-sm text-gray-700">
        Showing <span class="font-medium">{{ $works->count() > 0 ? 1 : 0 }}</span> to <span
            class="font-medium">{{ $works->count() }}</span> of <span class="font-medium">{{ $works->count() }}</span>
        jobs
    </div>
    @if ($works->count() == 0)
        ...
        <div class="p-6">
            ...
            <div class="mb-6">
                <p class="text-gray-700 mb-4">
                    Are you sure you want to delete the job posting "<span id="jobTitle"
                ...
                <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">This will permanently remove the job and all applications
                            </p>
                        </div>
                    </div>
                </div>
