    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <button type="submit"
                    class="bg-indigo-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-indigo-700 transition-all duration-200 transform hover:scale-105 shadow-lg">
                ...
                <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="industry"
                                ...
                                <option value="Technology"
                                    {{ old('industry', auth()->user()->industry) == 'Technology' ? 'selected' : '' }}>
                                    Technology</option>
                                ...
                                <option value="Marketing"
                                    {{ old('industry', auth()->user()->industry) == 'Marketing' ? 'selected' : '' }}>
                                    Marketing</option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="company_size"
                                ...
                                <option value="1-10 employees"
                                    {{ old('company_size', auth()->user()->company_size) == '1-10 employees' ? 'selected' : '' }}>
                                    1–10 employees</option>
                                <option value="11-50 employees"
                                    {{ old('company_size', auth()->user()->company_size) == '11-50 employees' ? 'selected' : '' }}>
                                    11–50 employees</option>
                                <option value="51-200 employees"
                                    {{ old('company_size', auth()->user()->company_size) == '51-200 employees' ? 'selected' : '' }}>
                                    51–200 employees</option>
                                <option value="201-500 employees"
                                    {{ old('company_size', auth()->user()->company_size) == '201-500 employees' ? 'selected' : '' }}>
                                    201–500 employees</option>
                                <option value="500+ employees"
                                    {{ old('company_size', auth()->user()->company_size) == '500+ employees' ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="number" value="{{ auth()->user()->founded_year }}" name="founded_year"
                                placeholder="2020"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea rows="4" name="description" placeholder="Tell us about your company..."
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none">{{ old('description', auth()->user()->description) }}</textarea>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Website</label>
                            <input type="url" name="company_website" value="{{ auth()->user()->company_website }}"
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-8">
        ...
        <div class="flex items-center justify-center">
            <div class="text-center">
                ...
                @else
                    <div
                        class="w-32 h-32 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl mx-auto mb-4 flex items-center justify-center">
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" name="city" value="{{ auth()->user()->city }}" placeholder="Kathmandu"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">State/Province</label>
                    <input type="text" name="state" value="{{ auth()->user()->state }}" placeholder="Bagmati"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="linkedin" value="{{ auth()->user()->linkedin }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="company_twitter" value="{{ auth()->user()->company_twitter }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="company_facebook"value="{{ auth()->user()->company_facebook }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="company_instagram"
                            value="{{ auth()->user()->company_instagram }}" placeholder="https://instagram.com/..."
                            class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                </div>
            </div>
