...
<div class="flex h-screen flex-col md:flex-row">
    ...
    <div class="flex-1 md:flex hidden flex-col justify-between bg-gray-100 p-6">
        <div class="text-center mt-6">
            <img src="images/login.svg" alt="signin Image" class="w-full object-cover mx-auto h-auto rounded-lg shadow-none">
        </div>
    </div>
    ...
    <div class="flex-1 text-black p-8 flex flex-col justify-center items-center bg-gray-200">
        ...
        <div class="mt-4 text-sm text-black">
            <p>Don't have an account? <a href="{{route('register')}}" class="text-blue-600 hover:underline font-bold">Sign Up</a>
            </p>
        </div>
    </div>
</div>
